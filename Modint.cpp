...
struct Modint{
    ...
    inline constexpr Modint operator+ (Modint x) const { ll a = _num + x._num; if(a >= mod) a -= mod; return Modint{a}; }
    ...
    inline constexpr Modint operator++(int){ Modint ans = *this; if(_num == mod - 1) _num = 0; else _num++; return ans; }
    inline constexpr Modint operator- () const { if(_num == 0) return 0; return Modint(mod - _num); }
    inline constexpr Modint operator- (int x) const { return Modint(_num - x); }
    inline constexpr Modint operator- (ll x) const { return Modint(_num - x); }
    inline constexpr Modint operator- (Modint x) const { ll a = _num - x._num; if(a < 0) a += mod; return Modint{a}; }
    inline constexpr Modint& operator-=(int x){ _num -= x; _num %= mod; if(_num < 0) _num += mod; return *this; }
    inline constexpr Modint& operator-=(ll x){ _num -= x; _num %= mod; if(_num < 0) _num += mod; return *this; }
    ...
    inline constexpr Modint operator--(int){ Modint ans = *this; if(_num == 0) _num = mod - 1; else _num--; return ans; }
    inline constexpr Modint operator* (int x) const { return Modint(_num * (x % mod)); }
    inline constexpr Modint operator* (ll x) const { return Modint(_num * (x % mod)); }
    inline constexpr Modint operator* (Modint x) const { return Modint{_num * x._num % mod}; }
    ...
    inline constexpr Modint operator/ (int x) const { return Modint(_num * invmod(Modint(x), mod)); }
    inline constexpr Modint operator/ (ll x) const { return Modint(_num * invmod(Modint(x), mod)); }
    inline constexpr Modint operator/ (Modint x) const { return Modint{_num * invmod(x._num, mod) % mod}; }
